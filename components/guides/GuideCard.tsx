...
export function GuideCard({ guide }: { guide: Guide }) {
  ...
  return (
    <article className="group relative h-full overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.04] transition duration-300 hover:-translate-y-1 hover:border-[#B8F23D]/50 hover:bg-white/[0.065]">
      <div className="relative aspect-[16/10] overflow-hidden bg-[#20261E]">
        <Image src={visual.src} alt={visual.alt} fill sizes="(min-width:1280px) 33vw, (min-width:768px) 50vw, 100vw" className="object-cover transition-transform duration-700 motion-safe:group-hover:scale-105" />
